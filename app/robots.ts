...
export const robots:RobotDefinition[]=[
 ...
 {id:'unitree-laikago',name:'Laikago',maker:'Unitree Robotics',company:'unitree',kind:'quadruped',introduced:'2017',summary:'An early electric quadruped research platform and predecessor to Unitree’s later robots.',height:'0.55 m',mass:'22 kg',dof:'12',license:'MPL-2.0',formats:['MJCF','URDF'],source:'https://github.com/unitreerobotics/unitree_ros/tree/master/robots/laikago_description',accent:'#b8ff44',morphology:{height:.55,shoulders:.4,body:.7,limb:.66},components:quadruped,model:unitreeModel('unitree-laikago','laikago_description','urdf/laikago.urdf')},
];
